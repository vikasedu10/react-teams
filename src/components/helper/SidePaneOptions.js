...
export const SidePaneOptions = () => {
    return (
        <div className='d-flex flex-column'>
            <div className="list-group">
                <Link to={"/teams/activity"} type="button" className="border-0 list-group-item list-group-item-action">
                    <div className='row text-center my-3'>
                        <i className="fa-icon-group fa-solid fa-chart-line"></i>
                        <span>Activity</span>
                    </div>
                </Link>
                <Link type="button" className="border-0 list-group-item list-group-item-action">
                    <div className='row text-center my-3'>
